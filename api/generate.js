...
const STRIPE_SECRET_KEY = "PASTE_STRIPE_SECRET_KEY_HERE";
const STRIPE_WEBHOOK_SECRET = "PASTE_WEBHOOK_SECRET_HERE";
const STRIPE_UNLOCK_PRICE_ID = "PASTE_UNLOCK_PRICE_ID_HERE";
const STRIPE_SUBSCRIPTION_PRICE_ID = "PASTE_SUB_PRICE_ID_HERE";
